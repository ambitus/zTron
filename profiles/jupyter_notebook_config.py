...
## Hashed password to use for web authentication. Ignored if
#  use_system_authentication is True.
#
...
## Use system authentication. Defaults to true if the python executable has the
#  program control attribute set. If this is true, the configured password is not
#  used.
#c.NotebookApp.use_system_authentication = False
...
## Total number of kernels concurently running, each kernel represents
#  five ports being used. Must be set with starting_port
#c.ConnectionFileMixin.max_kernels = 0

## set the shell (ROUTER) port [default: random]
#c.ConnectionFileMixin.shell_port = 0

## The starting port for kernels, must set max_kernels if using this.
#c.ConnectionFileMixin.starting_port = 0
